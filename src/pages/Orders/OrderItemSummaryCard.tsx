          ...
          >
            <div className="flex items-center gap-4">
              {item.product_variant?.images?.[0] ? (
                ...
                <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-md bg-slate-100 text-[10px] text-slate-400">
                  N/A
                </div>
              )}
              <div className="flex flex-col">
                <p className="text-sm font-semibold text-slate-800">
                  {item.product_variant?.name ?? "Product no longer available"}
                </p>
